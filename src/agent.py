...
class PPO(OnPolicyAlgorithm):
    ...
    def train(self) -> None:
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                actions = rollout_data.actions.long().flatten() if isinstance(self.action_space, spaces.Discrete) else rollout_data.actions
                ...
                ) if clip_range_vf is not None else values
    ...
    def learn(
        ...
        checkpoint_path: Optional[str] = None,  # New parameter for checkpoint path
    ) -> SelfPPO:
